...
export const Flag = {
  ...
  OPENCODE_DISABLE_SHARE: !falsy("OPENCODE_DISABLE_SHARE"),
  OPENCODE_ALLOWED_PROVIDERS: (process.env["OPENCODE_ALLOWED_PROVIDERS"] ?? "openai-compatible")
    .split(",")
    .map((s) => s.trim())
    .filter(Boolean),
  ...
  OPENCODE_DISABLE_LSP_DOWNLOAD: !falsy("OPENCODE_DISABLE_LSP_DOWNLOAD"),
  OPENCODE_DISABLE_RIPGREP_DOWNLOAD: !falsy("OPENCODE_DISABLE_RIPGREP_DOWNLOAD"),
  ...
  OPENCODE_DISABLE_EXTERNAL_SKILLS: OPENCODE_DISABLE_CLAUDE_CODE_SKILLS || !falsy("OPENCODE_DISABLE_EXTERNAL_SKILLS"),
