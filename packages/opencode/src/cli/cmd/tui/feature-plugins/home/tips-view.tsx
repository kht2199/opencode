...
const TIPS = [
  ...
  "CloseCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "CloseCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "CloseCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent CloseCode from reading sensitive files",
  "Use {highlight}closecode run{/highlight} for non-interactive scripting",
  "Use {highlight}closecode --continue{/highlight} to resume the last session",
  "Use {highlight}closecode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}closecode serve{/highlight} for headless API access to CloseCode",
  "Use {highlight}closecode run --attach{/highlight} to connect to a running server",
  "Run {highlight}closecode upgrade{/highlight} to update to the latest version",
  "Run {highlight}closecode auth list{/highlight} to see all configured providers",
  "Run {highlight}closecode agent create{/highlight} for guided agent creation",
  "Use {highlight}/closecode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}closecode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/closecode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}closecode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with CloseCode Zen for curated, tested models",
